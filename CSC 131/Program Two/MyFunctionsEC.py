...
def drawBoard(turtle):
    theBoard = turtle.Turtle()
    theBoard.pensize(5)

    # Horizontal lines
    theBoard.hideturtle()
    theBoard.penup()
    theBoard.setposition(-225, 85)
    theBoard.pendown()
    theBoard.setposition(225, 85)
    theBoard.penup()
    theBoard.setposition(-225, -85)
...
def stampPiece(turtle, playerPic, move, window):
    thePiece = turtle.Turtle()
    thePiece.penup()
    thePiece.shape(playerPic)

    if move == "1":
        thePiece.setposition(-160, 160)
        thePiece.stamp()
    if move == "2":
        thePiece.setposition(0, 160)
        thePiece.stamp()
    if move == "3":
        thePiece.setposition(160, 160)
        thePiece.stamp()
    if move == "4":
        thePiece.setposition(-160, 0)
        thePiece.stamp()
    if move == "5":
        thePiece.setposition(0, 0)
        thePiece.stamp()
    if move == "6":
        thePiece.setposition(160, 0)
        thePiece.stamp()
